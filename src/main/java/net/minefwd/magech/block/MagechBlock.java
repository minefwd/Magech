...
public class MagechBlock extends Block
{
    public MagechBlock(Material material)
    {
        super(material);
    ...
    {
        if (world.getTileEntity(x, y, z) instanceof MagechTileEntity)
        {
            int direction = 0;
            ...
            ((MagechTileEntity) world.getTileEntity(x, y, z)).setOrientation(direction);
        }
    }
